...
class TestModels(unittest.TestCase):
    ...
    def test_add_new_method_adds_new_user_email_to_user_list(self):
        ...
        self.new_user.add_new("mel", "mel@gmail.com", "123")
    ...
    def test_add_new_method_does_not_add_existing_user(self):
        ...
        self.new_user = UserAccount()
        self.new_user.add_new("mel", "mel@gmail.com", "123")
        result = self.new_user.add_new("mel", "mel@gmail.com", "123")
        self.assertEqual(result, "exists")

    def test_add_new_method(self):
        '''test whether user can create an account'''
        self.new_user = UserAccount()
        results = self.new_user.add_new("mel", "mel@gmail.com", "123")
    ...
    def test_login_method(self):
        ...
        self.assertEqual(results, 'SUCCESSFUL LOGIN')
    ...
    def test_delete_category(self):
        ...
        self.new_category.add_new_category("snacks")
        self.new_category.add_new_category("lunches")
        self.new_category.delete_category("snacks")
        results = self.new_category.view_category()
    ...
    def test_update_category(self):
        ...
        self.assertIn("lunch", self.new_category.defaultcategories)
    ...
    def test_add_new_recipe(self):
        ...
        self.new_recipe.add_new_recipe("githeri", "water maize beans", "mix")
        self.assertIn("githeri", self.new_recipe.defaultrecipe)
    
    def test_view_recipe(self):
        self.new_recipe = Recipe()
        self.new_recipe.add_new_recipe("githeri", "water maize beans", "mix")
        results = self.new_recipe.view_recipe("githeri")
